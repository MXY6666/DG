function Imp = computeImplicitMatrix(msh, md, U, Lamb, dU, dLamb, Jac1, k, m, dts, rnorm, flux, ME, IME, bs, SDC, KKT, newton)

AU = computePartOfTimeDerivative2(msh, md, U, 1, flux, ME, IME, bs);
if (k == 1)
    M11 = Jac1 - dts(m - 1) * AU;      
else
