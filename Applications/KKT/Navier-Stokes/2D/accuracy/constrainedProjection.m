function [U, Lamb, fail] = constrainedProjection(msh, U, nt, t, flag, tc, quad2, bs, KKT, newton, mtol)
...
for it = 1 : newton.maxit
    ...
    res = constrainedProjectionResidual(msh, U0, V(1 : 4 * KKT.NDOF), V(4 * KKT.NDOF + 1 : end), flag, tc, quad2, bs, KKT);
    scaRes = cpm.PR * res;
