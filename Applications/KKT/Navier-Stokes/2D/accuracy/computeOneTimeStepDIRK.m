function [U, Lamb, t, dt] = computeOneTimeStepDIRK(msh, md, U0, Lamb, nt, t, dt, CFLMax, tp, M, pr12, pc12, pv12, IME, tc, quad2, bs, bt, KKT, newton, mtol)
...
for it = 0 : newton.restart
    ...
    for s = 1 : bt.nstages
        ...
        % Update stage vector
        if (KKT.enable)
            [KStage, Lamb, LStage, k, fail] = NewtonLeastSquaresSemiSmoothActiveSet(msh, md, U0, KStage, Lamb, LStage, nt, t, dt, stage, M, pr12, pc12, pv12, IME, tc, quad2, bs, bt, KKT, newton, mtol);
        else
            [KStage, LStage, k, fail] = NewtonArmijoRule(msh, md, U0, KStage, LStage, nt, t, dt, stage, M, pr12, pc12, pv12, IME, tc, quad2, bs, bt, KKT, newton, mtol);
        end
