function Imp = computeImplicitMatrix(msh, md, U0, KStage, Lamb, dU, dLamb, dt, stage, rnorm, pr12, pc12, pv12, IME, tc, bs, bt, KKT, newton, mtol)
...
r12 = zeros(length(pr12) + 4 * (msh.nLElems + 4 * md.nIntLFaces) * bs.nb2, 1);
c12 = r12;
v12 = r12;

r21 = zeros(16 * (msh.nLElems + 4 * md.nIntLFaces) * bs.nb2, 1);
c21 = r21;
v21 = r21;
...
for n = 1 : 16
    ...
    ent1 = getJacobianEntry1(u(:, 1 : 4 : end), v(:, 1 : end / 2), v(:, end / 2 + 1 : end), u(:, 4 : 4 : end), tau11, tau12, i, j, tc);
    ent2 = getJacobianEntry2(u(:, 1 : 4 : end), v(:, 1 : end / 2), v(:, end / 2 + 1 : end), u(:, 4 : 4 : end), tau12, tau22, i, j, tc);
...
i = 4;
for j = 1 : 4
    ent1 = getJacobianEntry1(u(:, 1 : 4 : end), v(:, 1 : end / 2), v(:, end / 2 + 1 : end), u(:, 4 : 4 : end), tau11, tau12, i, j + 4, tc);
    ent2 = getJacobianEntry2(u(:, 1 : 4 : end), v(:, 1 : end / 2), v(:, end / 2 + 1 : end), u(:, 4 : 4 : end), tau12, tau22, i, j + 4, tc);
...
[alpha, dalphal, dalphar] = getDissCoeAndDeriv(ul1(1 : bs.nfp, :), ur1(1 : bs.nfp, :), vl1(1 : bs.nfp, :), vr1(1 : bs.nfp, :), vl1(bs.nfp + 1 : 2 * bs.nfp, :), vr1(bs.nfp + 1 : 2 * bs.nfp, :), pl, pr, 1, tc);
    
% block-(1,1)
for n = 1 : 16
    i = ceil(n / 4); j = n - (i - 1) * 4;
    
    entl = getJacobianEntry1(ul1(1 : bs.nfp, :), vl1(1 : bs.nfp, :), vl1(bs.nfp + 1 : end, :), ul1(3 * bs.nfp + 1 : end, :), tau11l, tau12l, i, j, tc);
    entr = getJacobianEntry1(ur1(1 : bs.nfp, :), vr1(1 : bs.nfp, :), vr1(bs.nfp + 1 : end, :), ur1(3 * bs.nfp + 1 : end, :), tau11r, tau12r, i, j, tc);   
    H_ul = 0.5 * (entl - dalphal((j - 1) * bs.nfp + 1 : j * bs.nfp, :) .* (ur1((i - 1) * bs.nfp + 1 : i * bs.nfp, :) - ul1((i - 1) * bs.nfp + 1 : i * bs.nfp, :)) + alpha * (i == j));
    H_ur = 0.5 * (entr - dalphar((j - 1) * bs.nfp + 1 : j * bs.nfp, :) .* (ur1((i - 1) * bs.nfp + 1 : i * bs.nfp, :) - ul1((i - 1) * bs.nfp + 1 : i * bs.nfp, :)) - alpha * (i == j));
...
i = 4; 
for j = 1 : 4
    entl = getJacobianEntry1(ul1(1 : bs.nfp, :), vl1(1 : bs.nfp, :), vl1(bs.nfp + 1 : end, :), ul1(3 * bs.nfp + 1 : end, :), tau11l, tau12l, i, j + 4, tc);
    entr = getJacobianEntry1(ur1(1 : bs.nfp, :), vr1(1 : bs.nfp, :), vr1(bs.nfp + 1 : end, :), ur1(3 * bs.nfp + 1 : end, :), tau11r, tau12r, i, j + 4, tc);  
    H_ul = 0.5 * entl;
    H_ur = 0.5 * entr;
...
% dissipation coefficient and its derivative 
[alpha, dalphal, dalphar] = getDissCoeAndDeriv(ul2(1 : bs.nfp, :), ur2(1 : bs.nfp, :), vl2(1 : bs.nfp, :), vr2(1 : bs.nfp, :), vl2(bs.nfp + 1 : 2 * bs.nfp, :), vr2(bs.nfp + 1 : 2 * bs.nfp, :), pl, pr, 2, tc);
              
% block-(1,1)
for n = 1 : 16
    i = ceil(n / 4); j = n - (i - 1) * 4;
    
    entl = getJacobianEntry2(ul2(1 : bs.nfp, :), vl2(1 : bs.nfp, :), vl2(bs.nfp + 1 : end, :), ul2(3 * bs.nfp + 1 : end, :), tau12l, tau22l, i, j, tc);
    entr = getJacobianEntry2(ur2(1 : bs.nfp, :), vr2(1 : bs.nfp, :), vr2(bs.nfp + 1 : end, :), ur2(3 * bs.nfp + 1 : end, :), tau12r, tau22r, i, j, tc);   
    H_ul = 0.5 * (entl - dalphal((j - 1) * bs.nfp + 1 : j * bs.nfp, :) .* (ur2((i - 1) * bs.nfp + 1 : i * bs.nfp, :) - ul2((i - 1) * bs.nfp + 1 : i * bs.nfp, :)) + alpha * (i == j));
    H_ur = 0.5 * (entr - dalphar((j - 1) * bs.nfp + 1 : j * bs.nfp, :) .* (ur2((i - 1) * bs.nfp + 1 : i * bs.nfp, :) - ul2((i - 1) * bs.nfp + 1 : i * bs.nfp, :)) - alpha * (i == j));
...
i = 4; 
for j = 1 : 4
    entl = getJacobianEntry2(ul2(1 : bs.nfp, :), vl2(1 : bs.nfp, :), vl2(bs.nfp + 1 : end, :), ul2(3 * bs.nfp + 1 : end, :), tau12l, tau22l, i, j + 4, tc);
    entr = getJacobianEntry2(ur2(1 : bs.nfp, :), vr2(1 : bs.nfp, :), vr2(bs.nfp + 1 : end, :), ur2(3 * bs.nfp + 1 : end, :), tau12r, tau22r, i, j + 4, tc);  
    H_ul = 0.5 * entl;
    H_ur = 0.5 * entr;
