...
function [KStage, LStage, k, fail] = NewtonArmijoRule(msh, md, U0, KStage, LStage, nt, t, dt, stage, M, pr12, pc12, pv12, IME, tc, quad1, bs, bt, KKT, newton, mtol)

% Initialize Newton solution vector
U = KStage(:, stage.Ks); 

% Newton step
[res, ~, waveVel] = computeResidual(msh, md, U0, KStage, [], LStage, t, dt, stage, M, IME, tc, quad1, bs, bt, KKT);
fail = true;
for k = 1 : newton.maxit
    if (k == 1 || L2_res > min(newton.tolres, 1.e-12))
        % Compute the Jacobian matrix 
        Imp = computeImplicitMatrix(msh, md, U0, KStage, [], [], [], dt, stage, [], pr12, pc12, pv12, IME, tc, bs, bt, KKT, newton, mtol);
    ...
    [res, LStage, waveVel] = computeResidual(msh, md, U0, KStage, [], LStage, t, dt, stage, M, IME, tc, quad1, bs, bt, KKT);
    scaRes = Imp.PR * res;
