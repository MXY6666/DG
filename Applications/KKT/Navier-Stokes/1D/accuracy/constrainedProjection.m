function [U, Lamb, fail] = constrainedProjection(msh, U, nt, t, flag, tc, quad1, bs, KKT, newton, mtol)
...
for it = 1 : newton.maxit
    ...
    res = constrainedProjectionResidual(msh, U0, V(1 : 3 * KKT.NDOF), V(3 * KKT.NDOF + 1 : end), flag, tc, quad1, bs, KKT);
    scaRes = cpm.PR * res;
