...
function [KStage, LStage, k, fail] = NewtonArmijoRule(msh, md, U0, KStage, LStage, nt, t, dt, stage, M, A, pr12, pc12, pv12, pr21, pc21, pv21, pr22i, pc22i, pv22i, IME, tc, quad1, bs, bt, inviscidFlux, KKT, newton, mtol)

% Initialize Newton solution vector
U = KStage(:, stage.Ks); 

% Newton step
[res, ~, waveVel] = computeResidual(msh, md, U0, KStage, [], LStage, t, dt, stage, M, A, IME, tc, quad1, bs, bt, inviscidFlux, KKT);
fail = true;
for k = 1 : newton.maxit
    if (k == 1 || L2_res > min(newton.tolres, 1.e-12))
        % Compute the Jacobian matrix 
        Imp = computeImplicitMatrix(msh, md, U0, KStage, [], [], [], dt, stage, [], A, pr12, pc12, pv12, pr21, pc21, pv21, pr22i, pc22i, pv22i, IME, tc, bs, bt, inviscidFlux, KKT, newton, mtol);
    ...
    [res, LStage, waveVel] = computeResidual(msh, md, U0, KStage, [], LStage, t, dt, stage, M, A, IME, tc, quad1, bs, bt, inviscidFlux, KKT);
    scaRes = Imp.PR * res;
