% Plot solutions
function plotSols(msh, U, W, Lamb, t, tc, quad1, bs, KKT)
...
vh_gp   = uh_gp(:, msh.nLElems + 1 : 2 * msh.nLElems) ./ rhoh_gp;
Th_gp   = getTemperature(rhoh_gp, vh_gp, uh_gp(:, 2 * msh.nLElems + 1 : end), wh_gp, tc);
