function [KStage, Lamb, LStage, k, fail] = NewtonLeastSquaresSemiSmoothActiveSet(msh, md, U0, KStage, Lamb, LStage, nt, t, dt, stage, M, Ax, Ay, pr12, pc12, pv12, pr21, pc21, pv21, pr22i, pc22i, pv22i, IME, tc, quad2, bs, bt, inviscidFlux, KKT, newton, mtol)

% Ensure that initial solution for active set Newton method is realizable
Lamb = checkCompatibility(msh, U0, KStage, Lamb, dt, stage, Ax, Ay, tc, bs, bt, KKT);
...
% Newton step
[res, ~, waveVel] = computeResidual(msh, md, U0, KStage, Lamb, LStage, t, dt, stage, M, Ax, Ay, IME, tc, quad2, bs, bt, inviscidFlux, KKT);
norm0 = norm(res);
rnorm = 1;
...
for k = 1 : newton.maxit
    if (k == 1 || L2_res > min(newton.tolres, 1.e-12))
        ...
        Imp = computeImplicitMatrix(msh, md, U0, KStage, Lamb, dV(1 : 4 * KKT.NDOF), dV(4 * KKT.NDOF + 1 : end), dt, stage, rnorm, Ax, Ay, pr12, pc12, pv12, pr21, pc21, pv21, pr22i, pc22i, pv22i, IME, tc, bs, bt, inviscidFlux, KKT, newton, mtol);
    ...
    [res, LStage, waveVel] = computeResidual(msh, md, U0, KStage, Lamb, LStage, t, dt, stage, M, Ax, Ay, IME, tc, quad2, bs, bt, inviscidFlux, KKT);
    scaRes = Imp.PR * res;
