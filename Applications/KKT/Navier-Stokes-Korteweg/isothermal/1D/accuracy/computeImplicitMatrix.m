function Imp = computeImplicitMatrix(msh, md, U, Lamb, dU, dLamb, Jac1, k, m, dts, rnorm, flux, A3, A32, ME, IME, bs, SDC, KKT, newton)

AU = computePartOfTimeDerivative2(msh, md, U, 1, flux, A3, A32, ME, IME, bs);
if (k == 1)
    M11 = Jac1 - dts(m - 1) * AU;      
else
    M11 = Jac1 - SDC.theta * dts(m - 1) * AU;
end
