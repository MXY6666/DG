...
[U0, Lamb] = computeInitialSolution(msh, md, tc, quad, bs, slo, KKT, newton, mtol);
...
if (pat == 1)
    plotSols(msh, U0, Lamb, 0, pn, tc, quad, bs, KKT)
end
...
while (t < tp - 1.0e-12)
    nt = nt + 1;
    [U0, Lamb, t, dt] = computeOneTimeStepDIRK(msh, md, U0, Lamb, nt, t, dt, CFLMax, tp, M, tc, quad, bs, bt, slo, KKT, newton, mtol); 
    
    % Plot the initial density
    if (pat == 1)
        plotSols(msh, U0, Lamb, t, pn, tc, quad, bs, KKT)
    end    
end     
