...
function msh = setQuadMesh_slope(domain, N, bcs, type, maxLevel, quad, bs, refine)
...
a = zeros(2, 4);
a(1, 1) = domain(1); a(1, 2) = domain(2); a(1, 3) = domain(3);
a(2, 1) = domain(4); a(2, 3) = domain(5); a(2, 4) = domain(6);
if refine
    it = [0, 0, 3, 3];
else
    it = zeros(1, 4);
